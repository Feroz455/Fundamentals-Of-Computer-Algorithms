/*
Compare the sorting methods MergeSort1 and QuickSort2 (Algorithm 3.11 & 3.15).
Devise data sets that compare both the average and worse-case times for these two algorithm
*/
#include <iostream>
#include <ctime>
#include <chrono>
