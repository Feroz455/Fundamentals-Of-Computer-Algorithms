/*
Page 188
09. The kth quantiles of an n-element set are the k-1 elements from
the set that devide the sorted set into k equal-sized sets.Give an O(nlogn)
time algorithm to lsit the kth quantiles of a set.
*/
#include <iostream>
#include <algorithm>
#include <climits>
...
/*
0 6 58 73 7 26 68 34 80 94 65 79 13 67 9 79 64 69 70 84 26 7 69 81 91 71 17 36 14 71 11 86 8 48 70 45 51 51 16 94 25 85 0 71 64 43 81 67 68 73 
0 0 6 7 7 8 9 11 13 14 16 17 25 26 26 34 36 43 45 48 51 51 58 64 64 65 67 67 68 68 69 69 70 70 71 71 71 73 73 79 79 80 81 81 84 85 86 91 94 94
*/