/*
Page 458
1) A polynomial of degree n > 0 has n derivatives each one obtained
by taking the derivative of the previous one. Devise an algorithm that produce the
value of a polynomial and its derivatives.
