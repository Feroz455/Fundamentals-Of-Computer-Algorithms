/*
Generalize Hamiltonian so that it processes a graph whose edges have costs
associated with them and finds a Hamiltonian cycle with minimum cost. You 
can assume that all edge are positive
*/
#include <stdio.h>
#include <iostream>
using namespace std;
