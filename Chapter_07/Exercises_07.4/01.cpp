/*
page 382
01) Program and run mColoring (Algorithm 7.7) using as data the complete graphs of size n = 2,3,4,5,6
and 7 . Let the desired number of colors be k = n; and k = n / 2. Tabulate the computing times for each values
*/
#include <stdio.h>
#include <iostream>
using namespace std;
