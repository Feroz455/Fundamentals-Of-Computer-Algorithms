/*
Suppose that each node in a binary search tree also has the field leftsize as discribed is the
text. Design an algorithm to insert an element x into such a binary search tree. The complexity
of your algorithm should be O(h) , where h is the height of the search tree. Show that this is the case;
*/
#include <iostream>
#include <ctime>
#include <cmath>
