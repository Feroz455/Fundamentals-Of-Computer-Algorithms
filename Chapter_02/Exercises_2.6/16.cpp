/*
page 135
16) Write an algorithm to input the number of vertices in an undirected graph and its edges 
one by one and to set up the linked adjacency-list representation of the grap. You may assume that no edge is
input twicee. What is the run time of your Procedure as a function of the number of vertices and the 
number of edges.
*/
#include <iostream>
#include <list>
