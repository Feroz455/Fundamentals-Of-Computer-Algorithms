/*
Page 292
03) Rewrite the algorithm BellmanFord so that the loop of lines 7 to 12 terminates
either after n - 1 iteration or after the first iteration in which no dist value are
changed, Which occure first.
*/
#include <bits/stdc++.h>
using namespace std;
